package com.asusoft.roomdatabaseexample.adapter
...
import com.asusoft.roomdatabaseexample.R
...
class ContactAdapter: ListAdapter<Contact, ContactAdapter.ContactViewHolder>(ContactComparator()) {
    ...
    class ContactViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        private val numberTextView: TextView = itemView.findViewById<TextView>(R.id.item_textview_number)
        private val initialTextView: TextView = itemView.findViewById<TextView>(R.id.item_textview_initial)
